                ...
                <div className={create.checkboxes}>
                  <div className={create.option}>
                    <input
                      type="checkbox"
                      defaultChecked={
                        tool?.categories.includes("research") ? true : false
                      }
                      {...register("research")}
                    />
                  ...
                  <div className={create.option}>
                    <input
                      type="checkbox"
                      defaultChecked={
                        tool?.categories.includes("ideation") ? true : false
                      }
                      {...register("ideation")}
                    />
                    Ideation
                  ...
                  <div className={create.option}>
                    <input
                      type="checkbox"
                      defaultChecked={
                        tool?.categories.includes("prototyping") ? true : false
                      }
                  ...
                  <div className={create.option}>
                    <input
                      type="checkbox"
                      defaultChecked={
                        tool?.categories.includes("evaluation") ? true : false
                      }
                      {...register("evaluation")}
                    />
                    Evaluation
